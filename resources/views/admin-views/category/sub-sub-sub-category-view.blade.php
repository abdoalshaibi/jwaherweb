...
@section('title', \App\CPU\translate('Sub Sub Sub Category'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('sub_sub_sub_category_form')}}
                    </div>
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.sub-sub-sub-category.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            @if($language)
                                ...
                                <div class="row">
                                    @foreach(json_decode($language) as $lang)
                                        <div
                                            ...
                                            <input type="text" name="name[]" class="form-control"
                                                   placeholder="{{\App\CPU\translate('New_sub_Sub_Sub_Category')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                    ...
                                    @else
                                        <div class="col-12">
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label
                                                    class="input-label">{{\App\CPU\translate('Sub_Sub_sub_category')}} {{\App\CPU\translate('name')}}
                                                    ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" class="form-control"
                                                       placeholder="{{\App\CPU\translate('New_Sub_Sub_Category')}}" required>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <div class="col-12 col-md-4">
                                            <label
                                                for="name">{{\App\CPU\translate('sub_sub_category')}} {{\App\CPU\translate('name')}}</label>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            if (id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('admin.sub-sub-sub-category.getSubCategory')}}',
                    data: {
                        id: id
                    },
                    success: function (result) {
