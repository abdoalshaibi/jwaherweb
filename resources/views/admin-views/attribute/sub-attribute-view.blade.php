...
@section('title', \App\CPU\translate('Sub Attribute'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('sub_Attribute')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('Add')}} {{ \App\CPU\translate('new')}} {{ \App\CPU\translate('sub_Attribute')}}
                    </div>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.sub-attribute.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
